...
namespace GIFT_OF_THE_GIVERS_fOUNDATION.Controllers
{
    public class LoginsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserID,FullName,Email,PasswordHash,Phone,Role,DateCreated")] Login login)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserID,FullName,Email,PasswordHash,Phone,Role,DateCreated")] Login login)
        {
            if (id != login.UserID)
            {
                return NotFound();
